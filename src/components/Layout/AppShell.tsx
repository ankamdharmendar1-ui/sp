              ...
              <div className="pt-2">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex h-9 w-9 items-center justify-center rounded-xl bg-white border border-[#d7cfc2] text-[#ff0000] hover:bg-[#ff0000] hover:text-white hover:border-[#ff0000] shadow-xs transition-colors"
                    aria-label="Subscribe to Real Picker Wheel on YouTube"
                  >
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
